...
## Introduction
In a game of TicTacToe two players take turns marking the squares in a three-by-three grid, with the goal of completing a straight line of three of their marks. DuckTacToe introduces a special rule: players not only place marks, but also have joint control of a small rubber duck which acts as a blocker.

## Rules
Standard TicTacToe rules apply:

- Two players choose either the X or O mark. Player X takes the first turn.
...
<img width="1200" height="650" alt="DuckTacToe" src="https://github.com/user-attachments/assets/39c412db-ea18-43d0-8af6-6059c404e607" />
